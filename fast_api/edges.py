from nodes import (
    RealEstateState,
    filter_node, re_questions, search_similar_questions, extract_keywords_based_on_db,
...
workflow.add_conditional_edges(
    "Filter Question",
    fiter_router,
    { 'Pass': "Search_Similar_Questions", 'Fail': 'Re_Questions'}
)
...
workflow.add_edge("Search_Similar_Questions", "Extract_keywords_based_on_db")
